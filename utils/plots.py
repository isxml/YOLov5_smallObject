...
from utils.general import is_ascii, is_chinese, user_config_dir, xywh2xyxy, xyxy2xywh, LOGGER
...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path('runs/detect/exp')):
    ...
    if 'Detect' not in module_type:
        ...
        if height > 1 and width > 1:
            ...
            plt.close()
def feature_visualization_rlt(x, module_type, stage, n=32, save_dir=Path('runs/detect/exp')):
    """
    x:              Features to be visualized 热力图
    module_type:    Module type
    stage:          Module stage within model
    n:              Maximum number of feature maps to plot
    save_dir:       Directory to save results
